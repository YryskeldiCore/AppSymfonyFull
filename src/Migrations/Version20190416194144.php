 ...
 */
final class Version20190416194144 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE last_name last_name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE first_name first_name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE middle_name middle_name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE age age INT NOT NULL, CHANGE phone phone VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE employ employ VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
